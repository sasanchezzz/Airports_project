...
from app.api.endpoints.v2.airports import v2_airports_router
from app.api.endpoints.v2.flights import v2_flights_router
from app.api.endpoints.v2.seats import v2_seats_router
from app.api.endpoints.v2.tickets import v2_tickets_router
...
router_v2.include_router(v2_airports_router)
router_v2.include_router(v2_flights_router)
router_v2.include_router(v2_seats_router)
router_v2.include_router(v2_tickets_router)
