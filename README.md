...
| `DB_PORT` | Порт базы данных | `55432` |
| `DB_NAME` | Имя базы данных | `demo` |
| `DB_USER` | Пользователь БД | `postgres` |
| `DB_PASSWORD` | Пароль БД | `5621` |
| `DB_ECHO` | Логирование SQL-запросов в консоль | `false` |
| `APP_HOST` | Хост приложения | `127.0.0.1` |
| `APP_PORT` | Порт приложения | `8000` |
| `APP_RELOAD` | Автоперезагрузка сервера | `true` |
